...
public enum Categoria {                          //  Declara un enum llamado Categoria. Los enum son tipos especiales que representan un conjunto limitado y constante de valores.
    ...
    ACCION("Action"),               //  Aquí defines los valores posibles del enum, y cada uno recibe un valor de texto asociado (la categoría que usaría una API externa como OMDb).
    ROMANCE("Romance"),             //  Por ejemplo: ACCION se mapea a "Action"  y COMEDIA se mapea a "Comedy"
    COMEDIA("Comedy"),
    DRAMA("Drama"),
    CRIMEN("Crime");
